...
const Filters = () => {
  ...
  const { filters: { text,  company, category, color,
        ...
        <form onSubmit={(e)=> e.preventDefault()}>
            {/* search input */}
              <div className="form-control">
                <input type='text' name='text'placeholder='search' className='search-input' value={text} onChange={ updateFilters }></input>
              </div>
            ...
            <div className="form-control">
              ...
              <div>
                ...
                categories.map((c, index) => {
                  ...
                  return <button type='button' key={index} name="category"
                    onClick={updateFilters} className={ `${category === c.toLowerCase() ? 'active' : null }`}>{c}</button>
                } )
                }
              </div>
              ...
              <div className="form-control">
               ...
               {/* end of company filters */}

                {/* start of color filters */}
                <div className="form-control">
                  <h5> colors</h5>
